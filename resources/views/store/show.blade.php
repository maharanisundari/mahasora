            ...
            <div>
                ...
                @auth
                    @if(auth()->user()->role==='admin')
                        <a href="{{ route('admin.store.edit') }}" class="inline-block mt-3 bg-white text-amber-700 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-slate-100">Edit Info Toko</a>
                    @endif
                @endauth
            </div>
        </div>

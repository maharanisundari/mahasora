    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-3">
            <div>
                ...
                <input type="text" name="phone" value="{{ old('phone') }}" class="w-full border border-amber-200 rounded-lg px-3 py-2 mt-1 focus:ring-2 focus:ring-amber-500 focus:outline-none">
            </div>
            <div>
